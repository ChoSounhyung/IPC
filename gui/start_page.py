...
class StartPage:
    def __init__(self):
        ...
        self.explain = Label(text=": IP 검색과 내 PC 지키미 결과를 제출, 확인해보아요!", bg='#ffffff', fg='#3F90CA',
                        font=("System 15 bold"))
        self.title.place(x=100, y=180, anchor='nw')
        self.explain.place(x=100, y=270, anchor='nw')
        ...
        student_click.place(x=100, y=360)
        ...
        teacher_click.place(x=290, y=360)
        ...
        notebook_smurf_label.place(x=580, y=100)
